...
const MetaPrototype = () => {
  ...
  const [characterState, setCharacterState] = useState({ x: 0, y: 0, jump: false, color: '#ef4444' });
  ...
  return (
    <div style={{
      ...
      <Stage characterState={characterState} onColorChange={(color) => setCharacterState(prev => ({ ...prev, color }))}
